...
func genLDFlags(version string) string {
	...
	ldflagsStr = "-s -w -X github.com/supriyo-biswas/mc/cmd.Version=" + version + " "
	ldflagsStr = ldflagsStr + "-X github.com/supriyo-biswas/mc/cmd.CopyrightYear=" + copyrightYear + " "
	ldflagsStr = ldflagsStr + "-X github.com/supriyo-biswas/mc/cmd.ReleaseTag=" + releaseTag + " "
	ldflagsStr = ldflagsStr + "-X github.com/supriyo-biswas/mc/cmd.CommitID=" + commitID() + " "
	ldflagsStr = ldflagsStr + "-X github.com/supriyo-biswas/mc/cmd.ShortCommitID=" + commitID()[:12]
	return ldflagsStr
}
